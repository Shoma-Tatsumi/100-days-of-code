...
本日も積み上げお疲れ様でした！<br>
・転職活動<br>
企業応募・greenのサイト登録、気になるボタンpush<br>
・アプリケーションのコメント欄の体裁を整えた<br>
コメント入力欄と投稿ボタンがの位置がずれていたのを修正<br>
#駆け出しエンジニア<br>
#100DaysOfCode
...
本日も一日お疲れさまんさ〜<br>
本日の積み上げ<br>
・fontawesomeを用いて、文字ばかりでなく記号も取り入れて、UI向上できたかな！私はそう思っている。。。<br>
・レスポンシブ対応にとりかかってて、明日で完成させる<br>
・読書して寝る（Web系エンジニアになろう）
#駆け出しエンジニア<br>
#100DaysOfCode<br>
...
本日も一日お疲れさまです！<br>
本日の積み上げ<br>
・レスポンシブ対応を実施　配置を変更したり、文字サイズを変更したり調整<br>
スマホを用いるのがほとんどなので、やはり対応させておかないとですね。<br>
#駆け出しエンジニア<br>
#100DaysOfCode
...
・チームでアプリケーション作成<br>
案を出し合い、チーム開発スタート<br>
今までは一人で作ってきたが、チームで意見を出し合い何か一つを作ることの面白さを味わえるのが楽しみ<br>
#駆け出しエンジニア<br>
#100DaysOfCode
...
本日のタスク<br>
・アバターを他要素にも追加<br>
・就活wantedlyプロフィール作成<br>
・チーム開発の企画決定<br>
金曜までにページレイアウト作成するcacooを用いて開発する
...
・転職用資料作成<br>
・チーム開発用trello設定<br>
転職関連に少し時間がかかってしまっている。時間を区切って実行する
